...
{
    public class SprintDetailDBAccess : ISprintDetailDataAccess
    {
        ...
        {
            dc.getContext.Add(newSprint);
        }

        public bool sprintChanged(Sprint sprint)
        {
            return dc.getContext.Entry(sprint).State != Microsoft.EntityFrameworkCore.EntityState.Unchanged;
        }
